    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        optionA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent optionAIntent = new Intent(QuestionFour.this, QuestionFive.class);
        ...
        optionB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent optionBIntent = new Intent(QuestionFour.this, QuestionFive.class);
        ...
        optionC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(QuestionFour.this,
                        "Wrong Answer!", Toast.LENGTH_SHORT).show();
                Intent optionCIntent = new Intent(QuestionFour.this, QuestionFive.class);
        ...
        optionD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(QuestionFour.this,
                        "Wrong Answer!", Toast.LENGTH_SHORT).show();
                Intent optionDIntent = new Intent(QuestionFour.this, QuestionFive.class);
