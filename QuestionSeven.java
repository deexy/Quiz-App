    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        optionA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent optionAIntent = new Intent(QuestionSeven.this, QuestionEight.class);
        ...
        optionB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent optionBIntent = new Intent(QuestionSeven.this, QuestionEight.class);
        ...
        optionC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(QuestionSeven.this,
                        "Wrong Answer!", Toast.LENGTH_SHORT).show();
                Intent optionCIntent = new Intent(QuestionSeven.this, QuestionEight.class);
        ...
        optionD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(QuestionSeven.this,
                        "Wrong Answer!", Toast.LENGTH_SHORT).show();
                Intent optionDIntent = new Intent(QuestionSeven.this, QuestionEight.class);
